...
export default function RulesDoc() {
  ...
  const conditions = [
    { nameKey: "conditionCountryName", icon: <TbWorld size={20} />, color: "bg-primary/10 text-primary", descKey: "conditionCountryDesc", opsKey: "conditionCountryOperators" },
    { nameKey: "conditionDeviceName", icon: <TbDeviceMobile size={20} />, color: "bg-warning/10 text-warning", descKey: "conditionDeviceDesc", opsKey: "conditionDeviceOperators" },
    { nameKey: "conditionVpnName", icon: <TbShieldLock size={20} />, color: "bg-info/10 text-info", descKey: "conditionVpnDesc", opsKey: "conditionVpnOperators" },
    { nameKey: "conditionBotName", icon: <TbRobot size={20} />, color: "bg-danger/10 text-danger", descKey: "conditionBotDesc", opsKey: "conditionBotOperators" },
    { nameKey: "conditionDateName", icon: <TbCalendar size={20} />, color: "bg-secondary/10 text-secondary", descKey: "conditionDateDesc", opsKey: "conditionDateOperators" },
    { nameKey: "conditionIpName", icon: <TbDots size={20} />, color: "bg-dark/10 text-dark", descKey: "conditionIpDesc", opsKey: "conditionIpOperators" },
    { nameKey: "conditionCountName", icon: <TbClick size={20} />, color: "bg-dark/10 text-dark", descKey: "conditionCountDesc", opsKey: "conditionCountOperators" },
  ] as const;

  const actions = [
    { nameKey: "actionRedirectName", icon: <TbArrowFork size={20} />, color: "bg-primary/10 text-primary", descKey: "actionRedirectDesc" },
    { nameKey: "actionBlockName", icon: <TbForbid2 size={20} />, color: "bg-danger/10 text-danger", descKey: "actionBlockDesc" },
    { nameKey: "actionPasswordName", icon: <TbLock size={20} />, color: "bg-warning/10 text-warning", descKey: "actionPasswordDesc" },
    { nameKey: "actionWebhookName", icon: <TbWebhook size={20} />, color: "bg-info/10 text-info", descKey: "actionWebhookDesc" },
  ] as const;
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <motion.div {...fadeUp} transition={s(1)}>
        ...
        <p className="text-sm text-dark/70 leading-relaxed mb-4">{t("howDesc")}</p>
        <div className="bg-dark rounded-2xl p-5 text-light text-sm font-mono space-y-1">
      ...
      <motion.div {...fadeUp} transition={s(2)}>
        ...
        <div className="space-y-2">
          {conditions.map((c) => (
            <div key={c.nameKey} className="flex items-start gap-3 p-4 rounded-2xl border border-dark/10">
              <span className={`p-1.5 flex items-center justify-center shrink-0 rounded-lg ${c.color}`}>{c.icon}</span>
      ...
      <motion.div {...fadeUp} transition={s(3)}>
        ...
        <p className="text-sm text-dark/70 leading-relaxed mb-4">{t("logicDesc")}</p>
      ...
      <motion.div {...fadeUp} transition={s(4)}>
        ...
        <div className="space-y-2">
          {actions.map((a) => (
            <div key={a.nameKey} className="flex items-start gap-3 p-4 rounded-2xl border border-dark/10">
              <span className={`p-1.5 shrink-0 rounded-lg ${a.color}`}>{a.icon}</span>
              <div className="min-w-0">
                <p className="text-sm text-dark/70">
